package org.blankenship.movies.util;
...
public class DTOModelMapper extends RequestResponseBodyMethodProcessor {
    ...
    public DTOModelMapper(ObjectMapper objectMapper, MongoTemplate entityManager) {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (id == null) {
            ...
            Object persistedObject = entityManager.findById(id, parameter.getParameterType());
